...
def play():
    ...
    while True:
        ...
        if 'bye' in query or 'thanks mate' in query:
            ...
            var.set('My Creators are Kshitij, Rajat & Himanshu')
            window.update()
            speak('My Creators are Kshitij Rajat and Himanshu')
            ...
            os.startfile("C:\\Users\\kunal\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Spotify")
            ...
            indx = query.lower().split().index('current')
...
clicked = StringVar()
clicked.set("Task I can Perform")
